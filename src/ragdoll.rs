...
use crate::body_parts::{spawn_body_part, create_joint, BodyPartConfig, JointConfig};
...
fn spawn_ragdoll(commands: &mut Commands, position: Vec2) {
    ...
    let torso = spawn_body_part(commands, BodyPartConfig {
        size: torso_size,
    ...
    let left_upper_arm = spawn_body_part(commands, BodyPartConfig {
        size: upper_arm_size,
    ...
    let left_lower_arm = spawn_body_part(commands, BodyPartConfig {
        size: lower_arm_size,
    ...
    let right_upper_arm = spawn_body_part(commands, BodyPartConfig {
        size: upper_arm_size,
        position: position + Vec2::new(25.0, 15.0),
        color: skin_color,
        linear_damping: 0.3,
    ...
    let right_lower_arm = spawn_body_part(commands, BodyPartConfig {
        size: lower_arm_size,
        position: position + Vec2::new(25.0, -10.0),
        color: skin_color,
        linear_damping: 0.3,
    ...
    let left_upper_leg = spawn_body_part(commands, BodyPartConfig {
        size: upper_leg_size,
    ...
    let left_lower_leg = spawn_body_part(commands, BodyPartConfig {
        size: lower_leg_size,
    ...
    let right_upper_leg = spawn_body_part(commands, BodyPartConfig {
        size: upper_leg_size,
        position: position + Vec2::new(10.0, -15.0),
        color: pants_color,
        density: 1.2,
    ...
    let right_lower_leg = spawn_body_part(commands, BodyPartConfig {
        size: lower_leg_size,
        position: position + Vec2::new(10.0, -45.0),
        color: pants_color,
        density: 1.2,
    ...
    create_joint(commands, JointConfig {
        parent: head,
        child: torso,
